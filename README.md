...
8월 8일 - [python(알고리즘3_완전탐색)+알고리즘(풀이&코드리뷰)]()

8월 9일 - [python(알고리즘4_그래프)+알고리즘(풀이&코드리뷰)]()

8월 10일 - [python(알고리즘5_DFR(깊이우선탐색))+알고리즘(풀이&코드리뷰)]()

8월 11일 - [python(알고리즘6)+알고리즘(풀이&코드리뷰)+코테준비하기]()
